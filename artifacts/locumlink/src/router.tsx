...
export default function Router() {
  return (
    <Switch>
      ...
      <Route path="/account/settings">{() => <ProtectedRoute allowedRoles={["locum","clinic_admin","clinic_hr","clinic_scheduler","platform_admin"]}><Layout><AccountSettings /></Layout></ProtectedRoute>}</Route>
      ...
      <Route path="/clinic/notifications">{() => <ProtectedRoute allowedRoles={["clinic_admin", "clinic_hr"]}><Layout><ClinicNotifications /></Layout></ProtectedRoute>}</Route>
      ...
      <Route path="/admin/audit">{() => <ProtectedRoute allowedRoles={["platform_admin"]}><Layout><AdminAuditLog /></Layout></ProtectedRoute>}</Route>
